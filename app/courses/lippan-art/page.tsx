export default function TheArtofLippanCourseDetails() {
    return (
        <main className="flex-grow flex flex-col lg:flex-row gap-gutter max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-12 relative w-full">
...
<h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg">The Art of Lippan: Traditional Mud &amp; Mirror Work</h1>
...
<div className="bg-cover bg-center w-full h-full" data-alt="A high-quality, beautifully lit photograph of a pair of hands delicately placing a small mirror onto a clay mural. The setting is a bright, modern studio with soft off-white walls. The artwork features intricate geometric patterns typical of Lippan art. The overall aesthetic is warm, tactile, and premium, aligned with a modern craft studio vibe." style={{backgroundImage: `url(https://lh3.googleusercontent.com/aida-public/AB6AXuB0ThDuVb2OniJ7WjvUCvt2WCyo2E3mdyuwdOomyt_EsUYfXZROwlmMElUUCZg7R2hCQS8EPksrOUA8DNa6IYGDrwTsBKgVIifhm9uzNYZ50hmVZcxTZvuDMEbphB0-A_DhmJPMIYSDxQ4Y51zbqnup0HmEThNgiSSyKIXS_FB_-LG-JXEAF-RaJHkXysyatKC9c5EzMw_7PckGAr67Bkegu0RZX7LdOhVzPkR0SRxBYxr2iG43fPoO)`}}></div>
...
<h2 className="font-headline-md text-headline-md border-b border-surface-container-high pb-4">Course Overview</h2>
...
<section className="space-y-6">
<h2 className="font-headline-md text-headline-md pl-2">What You'll Learn</h2>
...
<div>
<h3 className="font-label-md text-label-md text-on-surface">Material Mastery</h3>
...
<span className="material-symbols-outlined text-primary mt-1" style={{fontVariationSettings: '\'FILL\' 1'}}>check_circle</span>
<div>
<h3 className="font-label-md text-label-md text-on-surface">Pattern Design</h3>
...
<span className="material-symbols-outlined text-primary mt-1" style={{fontVariationSettings: '\'FILL\' 1'}}>check_circle</span>
<div>
<h3 className="font-label-md text-label-md text-on-surface">Sculpting Techniques</h3>
...
<span className="material-symbols-outlined text-primary mt-1" style={{fontVariationSettings: '\'FILL\' 1'}}>check_circle</span>
<div>
<h3 className="font-label-md text-label-md text-on-surface">Finishing &amp; Sealing</h3>
...
<button className="w-full border-2 border-outline text-on-surface font-label-md text-label-md py-3 rounded-full hover:bg-surface-container-low transition-colors duration-200">
                    Gift this Course
                </button>
