export default function StudentDashboardBecomeaTrainerPromo() {
    return (
...
</section><section className="bg-primary-container/20 border border-primary-fixed rounded-2xl p-8 ambient-shadow"><div className="flex flex-col md:flex-row justify-between items-center gap-6"><div><h3 className="font-headline-md text-headline-sm md:text-headline-md text-on-primary-container mb-2">Turn Your Creativity Into Teaching</h3><p className="font-body-lg text-body-md text-on-primary-container/80 max-w-xl">Are you passionate about creative arts? Share your skills with the Lemon Academia community and become a trainer.</p></div><button className="whitespace-nowrap bg-primary text-on-primary font-label-md text-label-md px-6 py-3 rounded-lg hover:opacity-90 transition-opacity">Apply to Become a Trainer</button></div></section>
